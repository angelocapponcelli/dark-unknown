...
namespace Menu.Rebinding_UI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            if (action.actionMap.bindings.Where(binding => binding.action != newBinding.action).Any(binding => binding.effectivePath == newBinding.effectivePath))
            {
                Debug.Log("Duplicate binding found: " + newBinding.effectivePath);
                //MenuManager.Instance.OpenNotification();
                return true;
            }
