...
public class PurpleProjectile : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        foreach (var element in hitEnemies)
        {
            ...
            if (element.gameObject.CompareTag("EnemyCollider") || element.gameObject.CompareTag("EnemyFeetCollider") || collision.gameObject.CompareTag("HiddenWormCollider")) return;
        }
