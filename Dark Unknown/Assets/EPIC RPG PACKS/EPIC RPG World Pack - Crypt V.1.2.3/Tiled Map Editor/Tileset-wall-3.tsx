...
<tileset version="1.5" tiledversion="1.7.2" name="Tileset-wall-3" tilewidth="32" tileheight="32" tilecount="128" columns="16">
 <image source="../Tilesets/Tileset-wall-3.png" width="512" height="256"/>
 <tile id="34" probability="10"/>
 <wangsets>
  <wangset name="wall3" type="corner" tile="-1">
