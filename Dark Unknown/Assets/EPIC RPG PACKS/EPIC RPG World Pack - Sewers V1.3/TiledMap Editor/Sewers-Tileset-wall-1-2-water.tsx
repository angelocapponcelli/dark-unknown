...
<tileset version="1.5" tiledversion="1.7.2" name="wall-1-2-water" tilewidth="32" tileheight="32" tilecount="128" columns="16">
 <image source="../Tilesets/wall-1-2-water.png" width="512" height="256"/>
 <tile id="35" probability="10"/>
 <wangsets>
  <wangset name="wall-1-2-water" type="corner" tile="-1">
