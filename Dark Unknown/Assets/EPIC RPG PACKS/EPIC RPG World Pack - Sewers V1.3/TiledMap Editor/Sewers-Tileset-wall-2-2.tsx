...
<tileset version="1.5" tiledversion="1.7.2" name="wall-2-2" tilewidth="32" tileheight="32" tilecount="128" columns="16">
 <image source="../Tilesets/wall-2-2-no water- 3 tiles tall.png" width="512" height="256"/>
 <tile id="34" probability="10"/>
 <tile id="35" probability="10"/>
 <wangsets>
  <wangset name="wall-2-2" type="corner" tile="-1">
