...
<tileset version="1.5" tiledversion="1.7.2" name="wall-3" tilewidth="32" tileheight="32" tilecount="119" columns="17">
 <image source="../Tilesets/wall-3-1- inner orientation-no water.png" width="544" height="224"/>
 <wangsets>
  <wangset name="wall-3" type="corner" tile="-1">
